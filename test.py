...
class Dashboard(FloatLayout):
    def __init__(self, **kwargs):
        ...
        # Fuel BAR
        self.fuel_bar = Image(source='img/fuel.png', pos=(380, 50))
        self.add_widget(self.fuel_bar)

        # fuel_grey
        self.fuel_grey = Image(source='icon1/fuel_yellow.png', size =(64, 64), pos=(280, 20))
        self.add_widget(self.fuel_grey)

        # air_heater_grey
        self.air_heater_grey = Image(source='icon1/air_heater_grey.png', size =(64, 64), pos=(280, 110))
        ...
        # peregrev_grey
        self.peregrev_grey = Image(source='icon1/peregev_grey.png', size =(64, 64), pos=(-280, 20))
        self.add_widget(self.peregrev_grey)

        # block_grey
        self.block_grey = Image(source='icon1/block_grey.png', size =(64, 64), pos=(-280, 110))
        ...
        # KM
        self.km_label = Label(text='00123', font_name = 'Avenir.ttc', halign="right", text_size=self.size, font_size=32, pos=(-690,-150))
        self.add_widget(self.km_label)  
        
        # Moto Hour
        self.moto_hour_label = Label(text='00010', font_name = 'Avenir.ttc', halign="right", text_size=self.size, font_size=32, pos=(690,-150))
        ...
        # povorot_p_grey
        self.povorot_p_grey = Image(source='icon1/povorot_p_grey.png', size =(64, 64), pos=(450, 260))
        self.add_widget(self.povorot_p_grey)
        
        # povorot_l_grey
        self.povorot_l_grey = Image(source='icon1/povorot_l_grey.png', size =(64, 64), pos=(-450, 260))
        self.add_widget(self.povorot_l_grey)

        # povorot_pricep_grey
        self.povorot_pricep_grey = Image(source='icon1/povorot_pricep_grey.png', size =(64, 64), pos=(0, 260))
